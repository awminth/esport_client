...
<div class="login-container">
    <div class="pay-container">
        ...
        <form id="frmwithdrawwave" method="POST">
            <input type="hidden" name="action" value="withdrawwave" />
            <input type="hidden" name="current_amt" value="<?=$current_amt?>" />
            <div class="form-group">
                <label for="inputField">Receive Wave Name</label>
                <i class="fa fa-user"></i>
                <input type="text" name="kpayname" placeholder="Your Wave Name" required>
            </div>
            <div class="form-group">
                <label for="inputField">Receive Wave No</label>
                <i class="fas fa-phone-alt"></i>
                <input type="number" name="kpayno" placeholder="Your Wave No" required>
            </div>
            <div class="form-group">
            ...
            success: function(data) {
                if (data == 1) {
                    ...
                    showToast({
                        type: 'error',
                        title: 'Error!',
                        message: 'Invalid wave name or wave no',
                        duration: 1500
                    });
                } else if (data == 2) {
                    showToast({
